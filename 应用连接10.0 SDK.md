...
1. ```java
   dependencies {
       ……
       implementation files('libs/quick_login_android_10.0.0.jar')
       ……
   }
   ```
...
SDK单点登录时的界面又SDK实现，为了能让开发者修改布局，故把布局文件，资源文件提供给开发者自行修改，需要开发者把SDK所需的布局文件放到res目录下：

![img](file:///C:\Users\Liangtian\AppData\Roaming\Tencent\Users\1245196943\QQ\WinTemp\RichOle\52OHPM4@P}V11_[W%)NPZRI.png) 

![img](file:///C:\Users\Liangtian\AppData\Roaming\Tencent\Users\1245196943\QQ\WinTemp\RichOle\GGBZXV0M5P%]KN458E9%F}K.png) 
